        ...
        <div className="mt-16 max-w-4xl mx-auto glass rounded-lg overflow-hidden animate-scale-in">
          ...
          <div className="p-4 bg-discord-darker text-white">
            <div className="flex items-start mb-6">
              ...
              <div className="w-full border-l-4 border-green-500 pl-3">
                <div className="flex items-center mb-1">
                  <span className="font-bold text-white mr-2">SRC</span>
                  <span className="bg-blue-600 text-xs font-bold px-2 py-0.5 rounded text-white">APP</span>
                ...
                <div className="flex items-center mt-2">
                  ...
                  <div className="text-sm">
                    <span className="text-discord-green">speedrun.bot</span>
